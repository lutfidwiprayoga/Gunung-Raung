    ...
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th width="30px">:</th>
                                                <th>{{ date('l, d F Y', strtotime($pesanan->wisatawan->tanggal_turun)) }}
                                                </th>
                                            </tr>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->jenis_identitas }}</th>
                                            </tr>

                                            <tr>
                                                <th width="100px">NOMOR IDENTITAS</th>
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->nomor_identitas }}</th>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->email }}</th>
                                            </tr>

                                            <tr>
                                                <th width="100px">TANGGAL LAHIR</th>
                                                <th width="30px">:</th>
                                                <th>{{ date('d F Y', strtotime($pesanan->wisatawan->tanggal_lahir)) }}
                                                </th>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->jenis_kelamin }}</th>
                                            </tr>

                                            <tr>
                                                <th width="100px">ALAMAT</th>
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->alamat }}</th>
                                            </tr>

                                            <tr>
                                                <th width="100px">NO HP</th>
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->no_hp }}</th>
                                            </tr>
                                            @if ($pesanan->wisatawan->asal_kota == null)

                                            @else
                                                <tr>
                                                    <th width="100px">ASAL KOTA</th>
                                                    <th width="30px">:</th>
                                                    <th>{{ $pesanan->wisatawan->city->name }}</th>
                                                </tr>
                                            @endif
                                        </table>
                                    </div>
                                    <div class="col-md-6">
                                        <table class="table">
                                            @if ($pesanan->wisatawan->provinsi == null)

                                            @else
                                                <tr>
                                                    <th width="100px">PROVINSI</th>
                                                    <th width="30px">:</th>
                                                    <th>{{ $pesanan->wisatawan->province->name }}</th>
                                                </tr>
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->pekerjaan }}</th>
                                            </tr>

                                            <tr>
                                                <th width="100px">KEBANGSAAN</th>
                                                <th width="30px">:</th>
                                                <th>{{ $pesanan->wisatawan->kebangsaan->negara }}</th>
                                            </tr>

                                            <tr>
                                                <th width="100px">FOTO IDENTITAS</th>
                                                <th width="30px">:</th>
                                                <th><img src="{{ url('foto_wisatawan/' . $pesanan->wisatawan->foto_identitas) }}"
                                                        width="200px">
                                                </th>
                                            </tr>
                                        </table>
                ...
                <a href="{{ route('admin.payment') }}" class="btn btn-link">
